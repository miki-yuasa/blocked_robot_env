...
from safety_robot_env.envs.fetch.fetch_env import MujocoBlockedFetchEnv, MujocoFetchEnv

MODEL_XML_PATH = os.path.join("fetch", "blocked_push.xml")
DEFAULT_MODEL_XML_PATH = os.path.join("fetch", "push.xml")
    ...
    * v1: the environment depends on `mujoco_py` which is no longer maintained.
    ...
    def __init__(self, reward_type="sparse", **kwargs):
        ...
        MujocoFetchEnv.__init__(
            self,
            model_path=DEFAULT_MODEL_XML_PATH,
            has_object=True,
            block_gripper=True,
            n_substeps=20,
