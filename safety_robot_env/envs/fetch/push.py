...
class MujocoBlockedFetchPushEnv(MujocoBlockedFetchEnv, EzPickle):
    ...
    * `observation`: its value is an `ndarray` of shape `(25,)`. It consists of kinematic information of the block object and gripper. The elements of the array correspond to the following:
    ...
    | 6   | Initial obstacle x position in global coordinates                                                                                           | -Inf   | Inf    | object1                               |-                                       |-         | position (m)             |
    | 7   | Initial obstacle y position in global coordinates                                                                                           | -Inf   | Inf    | object1                               |-                                       |-         | position (m)             |
    | 8   | Initial obstacle z position in global coordinates                                                                                           | -Inf   | Inf    | object1                               |-                                       |-         | position (m)             |
    | 9   | Cumulative x displacement of the obstacle                                                                                                   | -Inf   | Inf    | object1                               |-                                       |-         | position (m)             |
    | 10  | Cumulative y displacement of the obstacle                                                                                                   | -Inf   | Inf    | object1                               |-                                       |-         | position (m)             |
    | 11  | Cumulative z displacement of the obstacle                                                                                                   | -Inf   | Inf    | object1                               |-                                       |-         | position (m)             |
    | 12  | Obstacle x position in global coordinates                                                                                                   | -Inf   | Inf    | object1                               |-                                       |-         | position (m)             |
    | 13  | Obstacle y position in global coordinates                                                                                                   | -Inf   | Inf    | object1                               |-                                       |-         | position (m)             |
    | 14  | Obstacle z position in global coordinates                                                                                                   | -Inf   | Inf    | object1                               |-                                       |-         | position (m)             |
    | 15  | Relative block x position with respect to gripper x position in global coordinates. Equals to x<sub>block</sub> - x<sub>gripper</sub>       | -Inf   | Inf    | object0                               |-                                       |-         | position (m)             |
    | 16  | Relative block y position with respect to gripper y position in global coordinates. Equals to y<sub>block</sub> - y<sub>gripper</sub>       | -Inf   | Inf    | object0                               |-                                       |-         | position (m)             |
    | 17  | Relative block z position with respect to gripper z position in global coordinates. Equals to z<sub>block</sub> - z<sub>gripper</sub>       | -Inf   | Inf    | object0                               |-                                       |-         | position (m)             |
    | 18  | Relative obstacle x position with respect to gripper x position in global coordinates. Equals to x<sub>obstacle</sub> - x<sub>gripper</sub> | -Inf   | Inf    | object1                               |-                                       |-         | position (m)             |
    | 19  | Relative obstacle y position with respect to gripper y position in global coordinates. Equals to y<sub>obstacle</sub> - y<sub>gripper</sub> | -Inf   | Inf    | object1                               |-                                       |-         | position (m)             |
    | 20  | Relative obstacle z position with respect to gripper z position in global coordinates. Equals to z<sub>obstacle</sub> - z<sub>gripper</sub> | -Inf   | Inf    | object1                               |-                                       |-         | position (m)             |
